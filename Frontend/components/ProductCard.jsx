  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4">
      <div className="relative">
        <Image src={Props.productImage} width={300} height={300} alt="product image" />
