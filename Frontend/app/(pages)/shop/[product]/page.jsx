        ...
        <div className="flex flex-col grow-1 gap-5 border rounded border-gray-300  shadow-md md:px-20 p-8">
          ...
          <div>
            <ul>
              ...
              <li className="text-gray-500">Availability: <span className="text-green-500">In Stock</span></li>
            </ul>
          </div>
          <div className="flex flex-col gap-2">
            <p>Size:</p>
            <div className="flex gap-2">
              <button className="border border-gray-500 py-2 px-4 rounded">S</button>
              <button className="border border-gray-500 py-2 px-4 rounded">M</button>
              <button className="border border-gray-500 py-2 px-4 rounded">L</button>
              <button className="border border-gray-500 py-2 px-4 rounded">XL</button>
            </div>
          </div>
